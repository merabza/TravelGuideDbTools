...
namespace TravelGuideDbTools.DbMigration.Migrations
{
    ...
    [Migration("20260916082353_MoveStateToUrls")]
    partial class MoveStateToUrls
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelGuideCore.Domain.UrlModels.UrlModel", b =>
                {
                    b.Property<int>("UrlId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelGuideCore.Domain.PlaceModels.PlaceModel", b =>
                {
                    ...
                    b.HasOne("TravelGuideCore.Domain.UrlModels.UrlModel", "UrlNavigation")
                        .WithMany()
                        .HasForeignKey("UrlId");
            ...
            modelBuilder.Entity("TravelGuideCore.Domain.UrlGraphNodes.UrlGraphNode", b =>
                {
                    b.HasOne("TravelGuideCore.Domain.UrlModels.UrlModel", null)
                        .WithMany()
